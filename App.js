  ...
  return (
    <div className="res-card">
      <img
        ...
        src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/bav18jquonl2rlquifhz"
      />
      <h5>Barbeque Nation </h5>
      <h5>
        <span>3.8</span> <span>40-45 min</span>
      </h5>
      <p>North Indian Barbeque...</p>
      <p>Rohini</p>
    </div>
  );
};
...
const AppLayout = () => {
  return (
    <div className="app">
      <Header />
      {/* Add the Body and Footer components here */}
      <Body />
    </div>
  );
};
